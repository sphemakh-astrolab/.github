...
See the [Semester 2 course plan and lab schedule](https://github.com/sphemakh-astrolab/.github/blob/main/course-plan/README.md) for the full list of labs (Lab IV – Lab IX) and the dates for Block 3 and Block 4.
